...
public class Launcher : MonoBehaviourPunCallbacks
{
    ...
    {
        ListAllPlayer();
        chatmanager.GetComponent<ChatManager0>().Broadcast(newPlayer.NickName + "님이 참가하셨습니다");
    }
    public override void OnPlayerLeftRoom(Player otherPlayer)
    {
        ListAllPlayer();
        chatmanager.GetComponent<ChatManager0>().Broadcast(otherPlayer.NickName + "님이 퇴장하셨습니다");
    }
