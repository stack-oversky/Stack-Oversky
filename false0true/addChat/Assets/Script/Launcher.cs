...
public class Launcher : MonoBehaviourPunCallbacks
{
    ...
    public GameObject chatmanager;  //추가
    void Start()
    {
        CloseMenu();
    ...
    public override void OnJoinedRoom() 
    {
        ...
        ListAllPlayer();
        chatmanager.GetComponent<ChatManager0>().ChatLogReset();    //추가
    }
    ...
    {
        ListAllPlayer();
        chatmanager.GetComponent<ChatManager0>().Broadcast(newPlayer.NickName + "님이 참가하셨습니다");      //추가
    }
    public override void OnPlayerLeftRoom(Player otherPlayer)
    {
        ListAllPlayer();
        chatmanager.GetComponent<ChatManager0>().Broadcast(otherPlayer.NickName + "님이 퇴장하셨습니다");    //추가
    }
